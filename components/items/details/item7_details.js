...
<button type="button" class="gfAdded">Item Added
<span class="tick">
<i class="fa fa-check"></i>
</span> 
</button>

        <span class="drop_btn7">
        ...
        <li> 
        <button type="button" name="Grilled Fish with Cheeps_1pack" id="gFish_C1" class="price" value="$3.00 for 1 plate">$3.00
 <i class="fa fa-cart-plus" id="pluss">1</i>       
        </button>
        </li>
           
           <li> 
        <button type="button" name="Grilled Fish with Cheeps_2packs" id="gFish_C2" class="price" value="$6.00 for 2 plate">$6.00
 <i class="fa fa-cart-plus" id="pluss">2</i>       
        </button>
        </li>
          
           <li> 
        <button type="button" name="Grilled Fish with Cheeps_3packs" id="gFish_C3" class="price" value="$8.00 for 3 plate">$8.00
